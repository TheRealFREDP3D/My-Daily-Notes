...
==PROJECT==
Train an AI using my Calibre e-book library (300+ Computer Science, Python and Hacking Books) to find information (text, image, code snippet, …) that I know is writted somewhere in one of these books.  
